...
ax.plot(df_30s['hotUse_energy_disag'], color='blue', label = '30sec Sample')
ax.plot(df_1t['hotUse_energy_disag'], color='green', label = '1min Sample')
ax.plot(df_5t['hotUse_energy_disag'], color='orange', label = '5min Sample')
ax.plot(df_30t['hotUse_energy_disag'], color='black', label = '30min Sample')
ax.plot(df_1h['hotUse_energy_disag'], color='purple', label = '1h Sample')
...
ax2.plot(df_30s['hotUse_energy_disag'], color='blue', label = '30sec Sample')
ax2.plot(df_1t['hotUse_energy_disag'], color='green', label = '1min Sample')
ax2.plot(df_5t['hotUse_energy_disag'], color='orange', label = '5min Sample')
ax2.plot(df_30t['hotUse_energy_disag'], color='black', label = '30min Sample')
ax2.plot(df_1h['hotUse_energy_disag'], color='purple', label = '1h Sample')
