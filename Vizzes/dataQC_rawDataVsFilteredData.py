...
df.drop(columns=['buildingID', 'coldInTemp', 'hotInTemp', 'hotOutFlowRate', 'hotOutTemp'])
...
axHotRaw.set_ylabel('GPM', fontsize = 16)
axHotRaw.set_xlabel('')
...
axColdRaw.set_ylabel('GPM', fontsize=16)
axColdRaw.set_xlabel('Time', fontsize=16)
...
axHotNew.set_ylabel('GPM', fontsize = 16)
axHotNew.set_xlabel('')
plt.xticks([])
plt.yticks(fontsize=12)
...
axColdNew.set_ylabel('GPM', fontsize=16)
axColdNew.set_xlabel('Time', fontsize=16)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
