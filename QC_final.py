...
from flowQC.flowQC_noiseReduction_Median import adaptiveMedianFilter
...
df['hotInFlowRate'] = adaptiveMedianFilter(df['hotInFlowRate'], 9, 301,0.5) # filter noise in hotInFlowRate
print('hotInFlowRate complete!')
print('Filtering noise from coldInFlowRate...')
df['coldInFlowRate'] = adaptiveMedianFilter(df['coldInFlowRate'], 9, 301,0.5) # filter noise in coldInFlowRate
